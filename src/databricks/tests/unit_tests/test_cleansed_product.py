...
from jobs.source.product import transform_test
...
def test_cleansed_product_transforms(input_df_cleansed_product: DataFrame, expected_df_cleansed_product: DataFrame) -> None:
    ...
    actual_df_cleansed_product: DataFrame = transform_test(input_df_cleansed_product) # Apply imported transform logic to the input product cleansed DF here
