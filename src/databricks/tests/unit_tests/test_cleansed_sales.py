...
from src.databricks.jobs.source.sales import transform
...
def test_cleansed_sales_transforms(input_df_cleansed_sales: DataFrame, expected_df_cleansed_sales: DataFrame) -> None:
    ...
    actual_df_cleansed_sales: DataFrame = transform(input_df_cleansed_sales) # Apply imported transform logic to the input sales cleansed DF here
